...
namespace MiniORM
{
    public class DbContext
    {
        ...
        private void MapNabigationProperties<TEntity>(DbSet<TEntity> dbSet)
            where TEntity : class, new()
        {
            var entityType = typeof(TEntity);
        ...
        private static bool IsObjectValid(object e)
        {
            ...
            var validationResult =
                Validator.TryValidateObject(e, validationContext, validationErrors,
